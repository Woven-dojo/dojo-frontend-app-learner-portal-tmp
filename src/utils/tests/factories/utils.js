...
export const resolveFactoryValue = (item) => (item instanceof MockFactory ? item.create() : item);
...
export const createManyMocks = (length, factory) => Array.from({ length }, () => factory.create());
